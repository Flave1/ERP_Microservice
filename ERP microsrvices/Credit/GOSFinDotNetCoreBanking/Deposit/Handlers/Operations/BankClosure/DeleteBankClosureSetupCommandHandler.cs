...
{
	public class DeleteBankClosureSetupCommandHandler : IRequestHandler<DeleteBankClosureSetupCommand, Delete_response>
    {
        ...
        public async Task<Delete_response> Handle(DeleteBankClosureSetupCommand request, CancellationToken cancellationToken)
        {
