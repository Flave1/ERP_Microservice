...
{
    public class GetAllAccountInformationQuery : IRequest<AccountResponse>
    {
        public class GetAllAccountInformationQueryHandler : IRequestHandler<GetAllAccountInformationQuery, AccountResponse>
        {
            ...
            public async Task<AccountResponse> Handle(GetAllAccountInformationQuery request, CancellationToken cancellationToken)
            {
