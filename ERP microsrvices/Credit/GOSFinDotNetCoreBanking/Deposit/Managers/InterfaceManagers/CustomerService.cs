...
namespace Deposit.Managers.InterfaceManagers
{
    public class CustomerService : ICustomerService
    {
        ...
        {
            //var customer = _dataContext.deposit_individual_customer_information.FirstOrDefault(e => e.IndividualCustomerId == request.CustomerId);
            //if (customer != null)
            //{
            //    customer.Deleted = false;
            //    var next_dormant_day = Return_dormancy_days(customer.IndividualCustomerId);
        ...
        public List<long> Return_this_account_operating_currencies(string CURRENCIES)
        {
            try { return CURRENCIES.Split(',').ToList().Select(long.Parse).ToList(); }
