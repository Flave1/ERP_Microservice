...
{
    public class DeleteNextOfKinCommand : IRequest<DeleteRespObj>
	{
		public List<int> ItemIds { get; set; }
		public class DeleteNextOfKinCommandHandler : IRequestHandler<DeleteNextOfKinCommand, DeleteRespObj>
		{
			...
			public async Task<DeleteRespObj> Handle(DeleteNextOfKinCommand request, CancellationToken cancellationToken)
			{
