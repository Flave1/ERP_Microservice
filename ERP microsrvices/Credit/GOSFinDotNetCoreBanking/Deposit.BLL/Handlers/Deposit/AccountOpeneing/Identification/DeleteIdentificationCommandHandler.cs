...
namespace Deposit.Handlers.Deposit.AccountSetup
{
	public class DeleteIdentificationCommand : IRequest<DeleteRespObj>
	{
		...
		public class DeleteIdentificationCommandHandler : IRequestHandler<DeleteIdentificationCommand, DeleteRespObj>
		{
			...
			public async Task<DeleteRespObj> Handle(DeleteIdentificationCommand request, CancellationToken cancellationToken)
			{
