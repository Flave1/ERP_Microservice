...
{
    public class AddUpdateDirectorsCommandHandler : IRequestHandler<AddUpdateDirectorsCommand, AccountOpeningRegRespObj>
    {
        ...
        public async Task<AccountOpeningRegRespObj> Handle(AddUpdateDirectorsCommand request, CancellationToken cancellationToken)
        {
