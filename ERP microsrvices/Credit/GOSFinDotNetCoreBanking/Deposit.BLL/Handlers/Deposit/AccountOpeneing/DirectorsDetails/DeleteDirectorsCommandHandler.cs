...
{
	public class DeleteDirectorsCommand : IRequest<DeleteRespObj>
	{
		public List<int> ItemIds { get; set; }
		public class DeleteDirectorsCommandHandler : IRequestHandler<DeleteDirectorsCommand, DeleteRespObj>
		{
			...
			public async Task<DeleteRespObj> Handle(DeleteDirectorsCommand request, CancellationToken cancellationToken)
			{
