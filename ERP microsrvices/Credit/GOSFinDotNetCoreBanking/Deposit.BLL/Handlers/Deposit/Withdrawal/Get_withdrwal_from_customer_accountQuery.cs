...
{
    public class Get_withdrwal_from_customer_accountQuery : IRequest<deposit_transaction_response>
    {
        public class Get_withdrwal_from_customer_accountQueryHandler : IRequestHandler<Get_withdrwal_from_customer_accountQuery, deposit_transaction_response>
        {
            private readonly DataContext _context;
            private readonly ICustomerService _customer;
            public Get_withdrwal_from_customer_accountQueryHandler(DataContext dataContext, ICustomerService customer)
            {
                _context = dataContext;
                _customer = customer;
            }
            public async Task<deposit_transaction_response> Handle(Get_withdrwal_from_customer_accountQuery request, CancellationToken cancellationToken)
            {
