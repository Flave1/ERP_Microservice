...
{
    public class DeleteChangeOfRateCommand : IRequest<DeleteRespObj>
	{
		public List<int> ItemIds { get; set; }
		public class DeleteChangeOfRateCommandHandler : IRequestHandler<DeleteChangeOfRateCommand, DeleteRespObj>
		{
			...
			public async Task<DeleteRespObj> Handle(DeleteChangeOfRateCommand request, CancellationToken cancellationToken)
			{
